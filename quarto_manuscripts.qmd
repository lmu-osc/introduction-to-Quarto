...
- The main `.qmd` document containing your manuscript must be named `index.qmd` by default. If you want to use another name, adjust the `article: index.qmd` line in the file `_quarto.yml`.
