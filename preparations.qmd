...
- RStudio comes with a version of Quarto preinstalled. However, this version can be outdated because Quarto is updated more frequently than RStudio. It is therefore recommended to install a recent version of Quarto after installing RStudio. You can download the current release version of Quarto [here](https://quarto.org/docs/download/release.html). To check the version of Quarto currently installed on your computer, you can run the following code in the Termina:
...
You are now ready to start with the first tutorial [on this page](tutorial-hello-quarto.qmd).
