...
The [Quarto tutorials](https://quarto.org/docs/get-started/) use the [Visual Editor](https://quarto.org/docs/visual-editor/) in RStudio. Whether you like this mode for working in the future is for you to decide. If, *after the workshop*, you come to the conclusion that you want to keep using the Visual Editor, we recommend to read [this page](https://quarto.org/docs/visual-editor/markdown.html) and have a look at the following RStudio settings: 
