...
- Rendering the final .qmd file you can download at the end of the tutorial (*authoring-complete.qmd*) will only work, if you also have the *references.bib* file in the same folder. This file was created automatically by RStudio when you inserted your first reference in the [citations](https://quarto.org/docs/get-started/authoring/rstudio.html#citations) section of the tutorial. The created bibliography file should look something like this:

  {{< downloadthis references.bib label="Download references.bib">}}
