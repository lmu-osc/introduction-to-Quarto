...
One can create multiple columns next to each other by structuring them using [Divs](https://quarto.org/docs/authoring/markdown-basics.html#divs-and-spans) with the classes `columns` and `column`:
...
Tabsets allow to put more content on a slide than the available space normally allows. Use a [Divs](https://quarto.org/docs/authoring/markdown-basics.html#divs-and-spans) with the class `panel-tabset`:
...
One can add a footer on any slide by creating a [Divs](https://quarto.org/docs/authoring/markdown-basics.html#divs-and-spans) with the class `footer`:
