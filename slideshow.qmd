---
title: Creating a slideshow with Quarto"
lang: en
---
...
```{=html}
<iframe class="slide-deck" width="100%" height="450" src="downloadable/demo_slideshow.html"></iframe>
```
...
{{< downloadthis downloadable/demo_slideshow.zip dname="demo_slideshow" label="Download source files as ZIP">}}
