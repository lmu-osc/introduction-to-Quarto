---
title: "Formatting Quarto documents in APA 7 style"
lang: en
---
...
Pick a preprint of your own and implement it using Quarto in the [APA 7](https://apastyle.apa.org/) manuscript style. You also can view an [example document](downloadable/demo_manuscript.pdf) that incorporates all features from this exercise.
...
{{< downloadthis downloadable/demo_manuscript.zip dname="demo_manuscript" label="Download source files as ZIP">}}
