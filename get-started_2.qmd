...
*After* completing the second tutorial, come back **here** and continue with the next tutorial [here](get-started_3.qmd).

:::{.callout-tip}
## Let's start
Now you can start the second tutorial at <https://quarto.org/docs/get-started/computations/>.
:::
