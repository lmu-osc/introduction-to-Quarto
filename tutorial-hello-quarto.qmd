...
*After* completing the first tutorial, come back **here** and continue with the next tutorial [on this page](tutorial-computations.qmd).
...
- The tutorial discusses the `format: html` option in the YAML header and implies that you can also use `format: pdf` or `format: docx`. Indeed the results for these two options will look like this:
  ...
  {{< downloadthis downloadable/_hello.pdf dname="hello" label="Download .pdf file">}}  {{< downloadthis downloadable/_hello.docx dname="hello" label="Download .docx file">}}
