...
4. Download the Pyodide Quarto extension
   ::: {.callout-note}
   You find the *quarto-pyodide* documentation [here](https://quarto.thecoatlessprofessor.com/pyodide/)
   :::
...
6. Check that the file `mywebr.qmd` renders successfully locally. In RStudio you can just click the *Render* button
   ...
   ```
   :::
7. When you are finished with your Quarto document and everything renders correctly, you can commit the file `mywebr.qmd` and the *\_extensions/coatless* folder to your git repository and push your changes to your Github project (this step is recommended but optional)
   ::: {.callout-note}
