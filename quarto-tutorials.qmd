...
The [Quarto](https://quarto.org/) website provides very well written beginner **tutorials** ([Quarto "Getting Started"](https://quarto.org/docs/get-started/)) and extensive online **documentation** ([Quarto "Guide"](https://quarto.org/docs/guide/)).
...
Before you start with the tutorials, please follow the preparations [on this page](preparations.qmd) (you can always use the navigation arrows on the bottom of the current page).

<!-- Download the raw .qmd file for this exercise: -->

<!-- {{< downloadthis quarto-tutorials.qmd dname="Exercise_One.qmd" label="Download .qmd">}} -->
