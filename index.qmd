...
If you have not seen many examples yourself, go to the official [Quarto Gallery](https://quarto.org/docs/gallery/) or have a look at the following presentation for a few examples, where we have used Quarto in our own work:
