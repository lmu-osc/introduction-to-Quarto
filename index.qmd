...
2. [Quarto Tutorials](quarto-tutorials.qmd) from the official Quarto project
3. [Tips and Comments](comments.qmd) from our own experiences of using Quarto
4. [Advanced Exercises](quarto-exercises.qmd) that are more challenging than the beginner Quarto tutorials
